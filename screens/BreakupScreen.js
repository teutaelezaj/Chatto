...
export default function BreakupScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "My girlfriend and I broke up recently. How can I start to move on?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to Heartache Healing with Nexus, your compassionate breakup companion! Going through a breakup can be tough, but you don't have to face it alone. I'm an intelligent chat bot designed to offer support and guidance during this difficult time. Whether you're seeking advice on moving on, coping with emotions, or navigating post-breakup challenges, I'm here to lend an empathetic ear and provide helpful breakup advice. Just share your feelings and concerns, and together we'll embark on a journey of healing and growth. Remember, you're stronger than you think!"
    );
  }, []);
