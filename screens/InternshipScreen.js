...
export default function InternshipScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "What internships should I do to help me get into law school?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to Internship Insights with Nexus, your trusted guide to landing the perfect internship! I'm an intelligent chat bot designed to help you navigate the exciting world of internships and kick-start your career. Whether you're a student exploring internship opportunities, seeking advice on applications and interviews, or looking for tips to make the most of your internship experience, I've got you covered. Just let me know your goals and questions, and I'll provide you with valuable insights, resources, and personalized guidance to help you excel in your internship journey. Together, let's pave the way to a successful career!"
    );
  }, []);
