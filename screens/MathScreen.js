...
export default function MathScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Hi Nexus! Can you explain a Diophantine equation to me?"
  );
