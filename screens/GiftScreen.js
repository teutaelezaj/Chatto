...
export default function MathScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "I need help buying my best friend a gift. She loves makeup, books, and her cat. What are some gift ideas you have?"
  );
