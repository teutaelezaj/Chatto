...
export default function YogaScreen({navigation, route}) {
    const [inputText, setInputText] = useState(
        "Give me some quick tips on how to meditate"
    );
    ...
    useEffect(() => {
        setBotRole(
            "Welcome to Zen Oasis with Nexus, your serene companion for yoga and meditation! I'm an intelligent chat bot designed to help you find inner peace, reduce stress, and enhance your well-being through the practices of yoga and meditation. Whether you're a beginner seeking guidance, looking for specific poses or meditation techniques, or in need of tips to incorporate mindfulness into your daily life, I'm here to assist you. Just let me know your intentions and questions, and I'll provide you with gentle guidance, soothing practices, and personalized recommendations to help you cultivate tranquility and balance. Together, let's embark on a journey of self-discovery and inner harmony!"
        );
    }, []);
