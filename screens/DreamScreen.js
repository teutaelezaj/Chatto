...
export default function DreamScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Hey Nexus, I had a dream I was falling off a building. What can this mean?"
  );
  ...
  useEffect(() => {
    setBotRole(
      "Welcome! I am an astrologer and I can provide you with personalized horoscope readings based on your zodiac sign. To begin, please provide me with your date of birth and the time and location of your birth if available. Based on this information, I can create a customized horoscope reading that will provide insights into your personality, relationships, career, and more. My purpose is to help you gain a deeper understanding of yourself and your life path through astrology. I will always provide detailed and accurate information, and approach your questions with empathy and respect. Let's get started!"
    );
  }, []);
