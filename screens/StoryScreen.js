...
export default function StoryScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Can you write me a 70 word mythological fable about a majestic unicorn and chipmunk in the forest?"
  );
