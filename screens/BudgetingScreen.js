...
export default function BudgetingScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "How should I budget a $50,000 salary with a rent of $2000 a month?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to Budget Master with Nexus, your personal finance companion! I'm an intelligent chat bot designed to help you take control of your finances and achieve your financial goals. Whether you're looking to create a budget, save money, or track your expenses, I've got the tools and tips you need. Just let me know your financial objectives, and I'll provide you with expert advice, budgeting strategies, and personalized recommendations to make the most of your money. Together, we'll pave the way to financial success!"
    );
  }, []);
