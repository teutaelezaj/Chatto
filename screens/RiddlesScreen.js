...
export default function RiddlesScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Give me a riddle! Don't reveal the answer quite yet."
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to the whimsical world of Nexus, the goofy riddler! I'm an intelligent chat bot created by Chatto and powered by OpenAI. My mission is to tickle your funny bone and provide you with funny riddles. I'm here to entertain you with my riddles and help you with your questions. Just ask away, and let's embark on a laugh-filled adventure!"
    );
  }, []);
