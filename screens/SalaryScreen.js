...
export default function SalaryScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "I am looking to negotiate a job offer. How should I go about this?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to Salary Negotiator with Nexus, your trusted advisor for securing the salary you deserve! I'm an intelligent chat bot designed to assist you in navigating the intricate world of salary negotiations. Whether you're starting a new job, seeking a raise, or exploring new career opportunities, I'm here to help you strategize and maximize your earning potential. Just share your situation and goals, and I'll provide you with valuable insights, negotiation techniques, and tailored advice to help you confidently approach salary discussions. Together, let's unlock your true value in the job market!"
    );
  }, []);
