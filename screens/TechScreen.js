...
export default function MathScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "I have a background in construction and I am looking to pivot into tech. What are some tips you have for me?"
  );
