...
export default function SWEScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "What are the 3 most popular and useful programming languages as of now, and what are each of their use cases?"
  );
