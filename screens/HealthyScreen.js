...
export default function HealthyScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "What is a quick and healthy snack I can have right now?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to NutriChef with Nexus, your culinary companion for delicious and nutritious recipes! I'm an intelligent chat bot designed to help you discover a world of healthy eating. Whether you're looking for quick and easy meals, dietary-specific recipes, or wholesome snacks, I've got you covered. Just let me know your dietary preferences or any specific ingredients you want to include or exclude, and I'll provide you with mouthwatering recipes that prioritize your well-being. From nourishing breakfast ideas to satisfying main courses and delightful desserts, I'll help you make every meal a nutritious delight. Let's embark on a flavorful journey of healthy eating together!"
    );
  }, []);
