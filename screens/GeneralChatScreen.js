...
function GeneralChatScreen({navigation, route}) {
    ...
    const saveConversation = async (updatedConversation) => {
        try {
            conversationHistories.push(updatedConversation);
