...
export default function GeneralChatScreen({navigation, route}) {
    const [inputText, setInputText] = useState(
        "Hey Nexus, I am looking to lose 10 pounds in a healthy and sustainable way. What are some tips you have for me?"
    );
