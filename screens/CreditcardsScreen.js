...
export default function CreditcardsScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Hey Nexus! What is a credit card and why do I need it?"
  );
  ...
  useEffect(() => {
    setBotRole(
        "Welcome to Credit Card Guru with Nexus, your go-to expert for all things credit cards! I'm an intelligent chat bot dedicated to helping you navigate the world of credit cards with ease. Whether you're looking for the best rewards programs, tips on improving your credit score, or guidance on choosing the right card for your needs, I've got you covered. Just ask me anything related to credit cards, and I'll provide you with detailed insights, recommendations, and answers. Let's unlock the secrets of credit cards together and make informed financial decisions!"
    );
  }, []);
