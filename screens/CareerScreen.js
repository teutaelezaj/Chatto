...
export default function GeneralChatScreen({ navigation, route }) {
  const [inputText, setInputText] = useState(
    "Hey Nexus! I am going to graduate with my degree in marketing. What are some job titles I can look into?"
  );
